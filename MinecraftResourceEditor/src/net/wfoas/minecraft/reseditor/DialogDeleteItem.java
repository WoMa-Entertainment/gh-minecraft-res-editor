...
public class DialogDeleteItem extends JDialog {
	...
	public DialogDeleteItem(ResEditorWindow resedit) {
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				okButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						MinecraftResEditor.deleteItemModel((String) comboBox.getSelectedItem());
						resedit.redesign();
						DialogDeleteItem.this.setVisible(false);
					}
				});
